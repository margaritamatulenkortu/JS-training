const elements = {
    ...
    },
    {
        ...
        "images": {
            "png": "https://deckofcardsapi.com/static/img/X2.png",
            "svg": "https://deckofcardsapi.com/static/img/X2.svg"
        }
    },
    {
        "value": "QUEEN",
    ...
    },
    {
        ...
        "images": {
            "png": "https://deckofcardsapi.com/static/img/X1.png",
            "svg": "https://deckofcardsapi.com/static/img/X1.svg"
        }
    }
],
    "success": true,
    "deck_id": "f37kq60iw983"
};
let newpile = [];
for (let i = 0; i < 54; i++) {
    newpile.push(elements.cards[i].code);
}
newpile = newpile.join();
console.log(newpile);
